...
export const Register = () => {
    ...
    const schema = yup.object().shape({
        ...
        documentation : yup.string().required(typed ? "cnpj obrigatorio" : "cpf obrigatorio").matches(typed ? /[0-9]{2}\.?[0-9]{3}\.?[0-9]{3}\/?[0-9]{4}\-?[0-9]{2}/ : /[0-9]{3}\.?[0-9]{3}\.?[0-9]{3}\-?[0-9]{2}/, typed ? "O cnpj tem 14 digitos" : "O cpf tem 11 digitos"),
        ...
        <>
            ...
            <StyleSectionRe>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Input label="Nome" type="text" placeholder={typed ? "Nome fantasia"  : "Digite seu nome"} {...register("name")} />
                    ...
                    <Input label="Confirmar senha" type="password" placeholder="Digite novamente sua senha" {...register("confirPass")} />
