    ...
    <>
      ...
      <StyleSectionRe>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {typed && <Input label="Localidade" type="text" placeholder="Digite sua cidade" {...register("locality")}/>}
          {errors.locality?.message && <SpanErro>{errors.locality.message}</SpanErro>}
          {typed && <Input label="Site" type="url" placeholder="Digite seu site" {...register("site")}/>}
